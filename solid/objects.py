...
class polygon(OpenSCADObject):
    ...
    def __init__(
        self,
        points: Union[Points, IncludedOpenSCADObject],
        paths: Indexes = None,
        convexity: int = None,
    ) -> None:
...
class circle(OpenSCADObject):
    ...
    def __init__(self, r: float = None, d: float = None, segments: int = None) -> None:
        super().__init__("circle", {"r": r, "d": d, "segments": segments})
...
class sphere(OpenSCADObject):
    ...
    def __init__(self, r: float = None, d: float = None, segments: int = None) -> None:
        super().__init__("sphere", {"r": r, "d": d, "segments": segments})
...
class rotate_extrude(OpenSCADObject):
    ...
    def __init__(
        self, angle: float = 360, convexity: int = None, segments: int = None
    ) -> None:
        super().__init__(
            "rotate_extrude",
            {"angle": angle, "segments": segments, "convexity": convexity},
        )
...
class surface(OpenSCADObject):
    ...
    def __init__(
        self, file, center: bool = None, convexity: int = None, invert=None
    ) -> None:
        super().__init__(
            "surface",
...
class child(OpenSCADObject):
    def __init__(
        self, index: int = None, vector: Sequence[int] = None, range=None
    ) -> None:
        super().__init__("child", {"index": index, "vector": vector, "range": range})
...
class children(OpenSCADObject):
    ...
    def __init__(
        self, index: int = None, vector: float = None, range: P23 = None
    ) -> None:
        super().__init__("children", {"index": index, "vector": vector, "range": range})
...
class import_dxf(OpenSCADObject):
    def __init__(
        self, file, origin=(0, 0), convexity: int = None, layer: int = None
    ) -> None:
        super().__init__(
            "import",
            {"file": file, "origin": origin, "convexity": convexity, "layer": layer},
        )
    ...
    if ns:
        ...
        for candidate_path in candidates:
            ...
            if namespace is not None:
                ...
                return namespace
    raise ValueError(
        f"Could not find .scad files at or under {scad}. \nLocations searched were: {candidates}"
    )
...
def _openscad_library_paths() -> list[Path]:
    ...
    default_paths = {
        ...
        "Windows": [
            Path(PureWindowsPath("C:/Program Files/OpenSCAD/libraries")),
            Path(
                PureWindowsPath("C:/Program Files/OpenSCAD/libraries")
            ),  # add others here
        ],
    }
...
def use(
    scad_file_path: PathStr,
    use_not_include: bool = True,
    dest_namespace_dict: dict = None,
):
    """
